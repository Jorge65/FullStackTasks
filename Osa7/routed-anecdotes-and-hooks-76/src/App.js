...
const CreateNew = (props) => {
  const {resetField: resetContentField, ...content} = useField('text')
  const {resetField: resetAuthorField, ...author} = useField('text')
  const {resetField: resetInfoField, ...info} = useField('text')
